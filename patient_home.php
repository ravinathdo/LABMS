            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <?php
                        $sql = "SELECT * FROM ld_invoice WHERE patient_id = '" . $_SESSION['user']['id'] . "' AND status_code = 'OPEN'";
                    ...
                    <div class="col-md-8">
                        <img width="100%" class="img-thumbnail" src="images/shutterstock_236668870.jpg" alt=""/>
                    </div>
                </div>
